 ...
 * @Author Wes Huhman
 */
public class Morgana implements Champion
{
	...
	{
		return asList(Species.ASPECT, Species.HUMAN, Species.MAGICALLY_ALTERED);
	}
	...
	{
		return asList(Region.DEMACIA, Region.TARGON);
	}
