 ...
 * @Author Wes Huhman
 */
public class Malzahar implements Champion
{
	...
	{
		return asList(Species.HUMAN, Species.VOID_BEING);
	}
	...
	{
		return asList(Region.SHURIMA, Region.VOID);
	}
