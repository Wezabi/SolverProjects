...
/**
 * <p>
 * Implementation of Aurelion Sol.
 * </p>
 * <p>
 * Copyright &copy; 2022 
 * </p>
 ...
 * @Author Wes Huhman
 */
public class AurelionSol implements Champion
{
	...
	{
		return asList(Species.CELESITAL, Species.DRAGON);
	}
	...
	{
		return asList(Region.RUNETERRA, Region.TARGON);
	}
