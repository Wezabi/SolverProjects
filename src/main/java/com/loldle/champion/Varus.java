 ...
 * @Author Wes Huhman
 */
public class Varus implements Champion
{
	...
	{
		return asList(Role.BOTTOM, Role.MIDDLE);
	}

	@Override
	public List<Species> getSpecies()
	{
		return asList(Species.DARKIN, Species.HUMAN);
	}
	...
	{
		return asList(Region.IONIA, Region.RUNETERRA, Region.SHURIMA);
	}
