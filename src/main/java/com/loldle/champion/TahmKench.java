 ...
 * @Author Wes Huhman
 */
public class TahmKench implements Champion
{
	...
	{
		return asList(Role.SUPPORT, Role.TOP);
	}

	@Override
	public List<Species> getSpecies()
	{
		return asList(Species.DEMON, Species.SPIRIT);
	}
	...
	{
		return asList(Region.BILGEWATER, Region.RUNETERRA);
	}
