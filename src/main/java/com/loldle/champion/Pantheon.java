 ...
 * @Author Wes Huhman
 */
public class Pantheon implements Champion
{
	...
	{
		return asList(Role.JUNGLE, Role.MIDDLE, Role.SUPPORT);
	}

	@Override
	public List<Species> getSpecies()
	{
		return asList(Species.ASPECT, Species.HUMAN);
	}
	...
	{
		return singletonList(Region.TARGON);
	}
