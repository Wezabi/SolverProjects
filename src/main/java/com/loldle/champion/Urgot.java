 ...
 * @Author Wes Huhman
 */
public class Urgot implements Champion
{
	...
	{
		return asList(Species.CHEMICALLY_ALTERED, Species.CYBORG, Species.HUMAN);
	}
	...
	{
		return asList(Region.NOXUS, Region.ZAUN);
	}
