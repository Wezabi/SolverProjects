 ...
 * @Author Wes Huhman
 */
public class Kayn implements Champion
{
	...
	{
		return asList(Species.DARKIN, Species.HUMAN, Species.MAGICALLY_ALTERED);
	}
	...
	{
		return asList(Region.IONIA, Region.NOXUS, Region.RUNETERRA, Region.SHURIMA);
	}
